...
import com.myConsole.common.utils.Constant;
...
import com.myConsole.common.validator.group.AliyunGroup;
import com.myConsole.common.validator.group.QcloudGroup;
import com.myConsole.common.validator.group.QiniuGroup;
import com.myConsole.modules.oss.cloud.CloudStorageConfig;
import com.myConsole.modules.oss.cloud.OSSFactory;
import com.myConsole.modules.oss.entity.SysOssEntity;
import com.myConsole.modules.oss.service.SysOssService;
import com.myConsole.modules.sys.service.SysConfigService;
...
public class SysOssController {
    ...
    public R delete(@RequestBody Long[] ids) {
        ...
        for(long id : ids){
            ossEntityList.add(sysOssService.getById(id));
        }
        Boolean isDeled =OSSFactory.build().deleFile(ossEntityList);
        if(isDeled){
